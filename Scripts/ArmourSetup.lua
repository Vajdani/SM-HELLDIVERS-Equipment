...
local armour = {
    {
        ...
        slot = "head",
        renderable = "$CONTENT_DATA/Objects/Renderables/char_helldiver_armour_helmet.rend",
        stats = {
    ...
    },
    {
        ...
        slot = "torso",
        renderable = "$CONTENT_DATA/Objects/Renderables/char_helldiver_armour_chestplate.rend",
        stats = {
    ...
    },
    {
        ...
        slot = "leg",
        renderable = "$CONTENT_DATA/Objects/Renderables/char_helldiver_armour_leggings.rend",
        stats = {
            damageReduction = 0.25
        },
        setId = "Helldiver"
    },
    {
        ...
        slot = "foot",
        renderable = "$CONTENT_DATA/Objects/Renderables/char_helldiver_armour_boots.rend",
        stats = {
            damageReduction = 0.15
        },
        setId = "Helldiver"
